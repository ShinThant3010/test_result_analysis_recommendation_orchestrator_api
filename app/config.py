...
DATA_GATHERING_ATTEMPTS_PATH = "/students/{student_id}/tests/{test_id}/attempts"
DATA_GATHERING_QUESTIONS_PATH = "/tests/{test_id}/questions"
TEST_ANALYSIS_PATH = "/test-analysis"
COURSE_RECOMMENDATION_PATH = "/recommendations"
